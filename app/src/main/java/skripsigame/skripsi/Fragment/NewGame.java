...
public class NewGame extends Fragment {
    List<Games> games;
    AdapterRVNew adapterRVNew;
    Games gamesModel = new Games();
    RecyclerView rv;
    TextView jdulnew,ratingnew,release_datenew;
    ImageView gambarnew;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View _view =inflater.inflate(R.layout.fragment_new_game, container, false);
        rv = (RecyclerView)_view.findViewById(R.id.rviewNew);
        jdulnew = (TextView) _view.findViewById(R.id.judulgamenew);
        release_datenew = (TextView) _view.findViewById(R.id.tanggalgamenew);
        gambarnew =(ImageView)_view.findViewById(R.id.gambarnew);
        ratingnew = (TextView)_view.findViewById(R.id.ratingangkanew);
    ...
    private void AmbilDataNew()
    {
        ...
        Call<List<Games>> call = gameService.newgame("Bearer "+tokens,email,page_number,item_count);
...
//                    gamesModel.setPhoto_url(image);
                ...
                adapterRVNew = new AdapterRVNew(games,ImageLoader.getInstance());
                rv.setAdapter(adapterRVNew);
            }
